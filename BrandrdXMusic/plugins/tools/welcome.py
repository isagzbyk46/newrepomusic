...
๏ 𝐌𝐀𝐃𝐄 𝐁𝐘 ➠ [Destek 📿](https://t.me/gitaristmusic12)
➖➖➖➖➖➖➖➖➖➖➖
""",
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(f"⦿ ᴀᴅᴅ ᴍᴇ ⦿", url=f"https://t.me/gitaristmusic12?startgroup=true")]])
        )
    except Exception as e:
        LOGGER.error(e)
    try:
